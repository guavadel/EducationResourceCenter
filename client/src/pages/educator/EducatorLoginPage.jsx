...
const onSubmit = async (data) => {
  ...
  try {
    ...
    // Navigate to the /educator route
    navigate('/home');
    navigate(0)
  ...
  return (
    <div className="container mx-auto mt-20 mb-10 flex space-x-2">
      {/* Left Div */}
      <div className="w-1/2 px-8 py-40 bg-gray-800 text-white flex flex-col justify-center items-center rounded-3xl">
        <h2 className="text-6xl font-bold mb-5">Welcome Back!</h2>
        <p className="text-lg mb-6 mx-28 text-center font-thin">
          Join our platform to manage your resources, track your progress, and connect with students. Log in to get started!
        </p>
      ...
      {/* Right Div */}
      <div className="w-1/2 px-8 py-40 bg-gray-900 rounded-3xl">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 p-10 px-20">
          <h3 className="text-2xl font-bold mb-6 text-gray-300">Educator Login</h3>
          <div className="mb-4">
