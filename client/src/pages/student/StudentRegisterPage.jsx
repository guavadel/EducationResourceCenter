...
const StudentRegisterPage = () => {
  ...
  <h2 className="text-6xl font-bold mb-5">Welcome Human!</h2>
  <p className="text-lg mb-6 mx-28 text-center font-thin">Create an account or Login to get started with our platform.  Join us today to make the most out of our services!</p>
  ...
  >
    Sign In
      ...
      <div className="w-1/2 px-8 py-10 bg-gray-900 rounded-3xl ">
        <form onSubmit={handleRegister} className="space-y-4 p-10">
          <h1 className='text-gray-300'>Create Account</h1>
          <div className="mb-4">
